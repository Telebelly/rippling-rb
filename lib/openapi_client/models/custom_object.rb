...
module OpenapiClient
  ...
  class CustomObject
    ...
    attr_accessor :native_category_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::CustomObject` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::CustomObject`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'plural_label')
        self.plural_label = attributes[:'plural_label']
      else
        self.plural_label = nil
      end
      ...
      if attributes.key?(:'native_category_id')
        self.native_category_id = attributes[:'native_category_id']
      end
    ...
    def list_invalid_properties
      ...
      if @plural_label.nil?
        invalid_properties.push('invalid value for "plural_label", plural_label cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @plural_label.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] plural_label Value to be assigned
    def plural_label=(plural_label)
      if plural_label.nil?
        fail ArgumentError, 'plural_label cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          api_name == o.api_name &&
          plural_label == o.plural_label &&
          category_id == o.category_id &&
          native_category_id == o.native_category_id &&
    ...
    def hash
      [id, created_at, updated_at, name, description, api_name, plural_label, category_id, native_category_id, managed_package_install_id, enable_history, owner_id].hash
    end
