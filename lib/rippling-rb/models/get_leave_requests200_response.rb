...
module RipplingRb
  class GetLeaveRequests200Response
    ...
    attr_accessor :number_of_minutes_requested
    ...
    attr_accessor :days_take_off

    # Whether the leave request is managed by an external system.
    attr_accessor :is_managed_by_external_system
    ...
    def self.attribute_map
      {
        ...
        :'end_time' => :'end_time',
        :'comments' => :'comments',
        :'number_of_minutes_requested' => :'number_of_minutes_requested',
        ...
        :'days_take_off' => :'days_take_off',
        :'is_managed_by_external_system' => :'is_managed_by_external_system'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'end_time' => :'String',
        :'comments' => :'String',
        :'number_of_minutes_requested' => :'Float',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RipplingRb::GetLeaveRequests200Response` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RipplingRb::GetLeaveRequests200Response`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'number_of_minutes_requested')
        self.number_of_minutes_requested = attributes[:'number_of_minutes_requested']
      end
      ...
      if attributes.key?(:'days_take_off')
        if (value = attributes[:'days_take_off']).is_a?(Array)
          self.days_take_off = value
        end
      end

      if attributes.key?(:'is_managed_by_external_system')
        self.is_managed_by_external_system = attributes[:'is_managed_by_external_system']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          end_time == o.end_time &&
          comments == o.comments &&
          number_of_minutes_requested == o.number_of_minutes_requested &&
          ...
          days_take_off == o.days_take_off &&
          is_managed_by_external_system == o.is_managed_by_external_system
    end
    ...
    def hash
      [__meta, id, created_at, updated_at, worker_id, worker, requester_id, requester, status, start_date, start_time, end_date, end_time, comments, number_of_minutes_requested, leave_policy_id, leave_type_id, leave_event_id, leave_type, reason_for_leave, reviewer_id, reviewer, reviewed_at, days_take_off, is_managed_by_external_system].hash
    end
