...
# Unit tests for RipplingRb::Country
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RipplingRb::Country do
  let(:instance) { RipplingRb::Country.new }

  describe 'test an instance of Country' do
    it 'should create an instance of Country' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(RipplingRb::Country)
    end
  end
