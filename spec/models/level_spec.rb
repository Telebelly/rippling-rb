...
# Unit tests for OpenapiClient::Level
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Level do
  let(:instance) { OpenapiClient::Level.new }

  describe 'test an instance of Level' do
    it 'should create an instance of Level' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Level)
    end
  end
