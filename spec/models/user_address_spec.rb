...
# Unit tests for RipplingRb::UserAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RipplingRb::UserAddress do
  let(:instance) { RipplingRb::UserAddress.new }

  describe 'test an instance of UserAddress' do
    it 'should create an instance of UserAddress' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(RipplingRb::UserAddress)
    end
  end
