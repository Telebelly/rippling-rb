...
# Unit tests for RipplingRb::AddressRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RipplingRb::AddressRequest do
  let(:instance) { RipplingRb::AddressRequest.new }

  describe 'test an instance of AddressRequest' do
    it 'should create an instance of AddressRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(RipplingRb::AddressRequest)
    end
  end
