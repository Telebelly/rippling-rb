...
# Unit tests for OpenapiClient::AddressRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AddressRequest do
  let(:instance) { OpenapiClient::AddressRequest.new }

  describe 'test an instance of AddressRequest' do
    it 'should create an instance of AddressRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AddressRequest)
    end
  end
