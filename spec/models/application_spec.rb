...
# Unit tests for RipplingRb::Application
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RipplingRb::Application do
  let(:instance) { RipplingRb::Application.new }

  describe 'test an instance of Application' do
    it 'should create an instance of Application' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(RipplingRb::Application)
    end
  end
