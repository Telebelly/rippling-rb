...
# Unit tests for RipplingRb::GetUsers200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RipplingRb::GetUsers200Response do
  let(:instance) { RipplingRb::GetUsers200Response.new }

  describe 'test an instance of GetUsers200Response' do
    it 'should create an instance of GetUsers200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(RipplingRb::GetUsers200Response)
    end
  end
