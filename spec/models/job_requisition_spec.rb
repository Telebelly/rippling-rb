...
# Unit tests for OpenapiClient::JobRequisition
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::JobRequisition do
  let(:instance) { OpenapiClient::JobRequisition.new }

  describe 'test an instance of JobRequisition' do
    it 'should create an instance of JobRequisition' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::JobRequisition)
    end
  end
